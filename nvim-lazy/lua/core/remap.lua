...
map("t", "<C-\\><C-\\>", "<C-\\><C-N><C-W><C-W>", { desc = "Exit term mode and swtich window" })
...
map("n", "<leader><leader>", vim.cmd.source, { desc = "Source current file" })
...
map("n", "<leader>fml", ":CellularAutomaton make_it_rain<CR>", { desc = "fml" })

map("n", "<leader>vpp", ":e ~/dotfiles/nvim/lua/redsalt/packer.lua<CR>", { desc = "Source neovim config" })
